# PA Email and Social Task - Tools

## Primary Tooling
- Email/social modules under `programs/personal-assistant`.
- Provider API integrations with audit logging for sent actions.
- Error alerts for delivery, auth, and policy violations.
